...
#pragma warning restore CS8618
    ...
    /// <summary>
    /// Add logic to dynamically build a database connection string for SQL Server in a container
    /// </summary>
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            builder.Password = Environment.GetEnvironmentVariable("MY_SQL_PWD"); // We already saved the password within PowerShell SecretMaagnment vault but it would take a bit to setup and fetch the data
